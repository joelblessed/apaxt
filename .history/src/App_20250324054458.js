...
function App() {
  ...
  const [nselectedProduct, msetSelectedProduct] = useState("");
  ...
  brand === "All" ? products : products.filter((product) => product.brand.b.name === brand);
      ...
      <Router>
        ...
        <Routes>
         ...
         ></Route>
           ...
           <Route
            ...
            element={
              <Category
                ...
                filteredProducts={filteredProducts}
                selectedCategory={selectedCategory}
                mSelectedProduct={mSelectedProduct}
                mobilefilteredProducts={mobilefilteredProducts}
                highlightText={highlightText}
                addToCart={addToCart}
                addToWishList={addToWishList}
          ...
          <Route path="/signUP" element={<SignUP api={api} allProfiles={allProfiles} />} />
          <Route
            path="/profile"
            element={
...
<Route
          ...
          <Route
            ...
            element={
                ...
                <ProductsByOwner api={api} highlightText={highlightText} searchTerm={searchTerm}  filteredProducts={filteredProducts} />
