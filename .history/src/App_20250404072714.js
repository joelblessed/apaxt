...
import WishlistPage from "./components/pages/wishlistButton";
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/desktopCards"
            element={
              <DesktopCards filteredProducts={filteredProducts} api={api} />
            }
          />
          ...
          <Route path="/wishListPage" element={<WishlistPage filteredProducts={filteredProducts} api={api} />} />
