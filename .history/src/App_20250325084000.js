...
function App() {
  ...
  const [ mobilefilteredProducts, setMobilefilteredProducts] = useState(null)
    ...
    fetch(`${api}/products`)
      ...
      .then((data) => {
        ...
        category === "All"
          ...
          setMobilefilteredProducts( mobileProducts)
    
      const filteredSeller =
        brand === "All"
          ? products
          : products.filter((product) => product.owner === userId);

          setProductsBySeller(filteredSeller)
