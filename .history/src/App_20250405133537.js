...
const [loader, setLoaderRef] = useState(null);
    ...
    <AuthProvider>
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/desktopCards"
            element={<DesktopCards Dobject={filteredProducts} setLoaderRef={loader} api={api} />}
          />
