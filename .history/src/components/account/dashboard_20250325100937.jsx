...
const Dashboard = ({ api, user, error ,ownersProducts}) => {
      ...
      <div style={styles.mainContent}>
        <Routes>
          ...
          <Route
            path="/dproducts"
            element={
              <Products products={products} error={error}  user={user} handleDelete={handleDelete} ownersProducts={ownersProducts} />
            }
          />
           <Route
...
// Products Component
const Products = ({ owner, api, handleDelete }) => {
  const { t } = useTranslation();
