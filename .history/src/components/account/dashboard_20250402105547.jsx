    ...
    <DashboardContainer>
      ...
      <MainContent>
        <Routes>
          ...
          <Route path="/dwallet" element={<Wallet error={error} user={user} />} />

          <Route
            path="/dprofile"
            element={
              <Profile user={user} error={error} api={api} useDispatch={useDispatch} />
            }
          />
...
const referralCode = user.referralCode
  ...
  const walletBalance = user.wallet + user.discount
