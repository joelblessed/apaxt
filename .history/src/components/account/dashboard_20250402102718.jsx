    ...
    <DashboardContainer>
      ...
      <MainContent>
        <Routes>
          ...
          <Route path="/dwallet" element={<Wallet user={user} />} />

          <Route
            path="/dprofile"
            element={
              <Profile user={user} api={api} useDispatch={useDispatch} />
            }
          />
...
const Wallet = ({ user  }) => {
  ...
  const referralLink = https://yourwebsite.com/signup?ref=${referralCode}1;
