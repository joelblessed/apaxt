...
const Home = ({brands}) => {
  ...
  return (
    <div style={{ textAlign: "center",background:"green",width:"1000px", marginTop: "20px", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px" }}>
      ...
      <div style={{ overflow: "hidden", width: "550px" ,background:"blue" }}>
        <div
          style={{
            display: "flex",
            gap: "10px",
