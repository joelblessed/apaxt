...
const FormUpload = ({api},location, locationName,latitude,longitude) => {
  ...
  const [location, setLocation] = useState(location[{ name:locationName, latitude, longitude}]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setLikes(0);
        setCity("")
        setLocation(location[{ name:locationName, latitude, longitude}]);
