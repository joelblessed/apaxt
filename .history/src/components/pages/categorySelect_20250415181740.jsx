...
const Category = ({
  ...
  const [category, setCategory] = useState(categorriesName || "All");
  ...
  useEffect(() => {
    if (categorriesName || searchTerm.trim() !== "") {
      const results = fuse.search(searchTerm.trim() || categorriesName.trim());
  ...
  }, [searchTerm, categorriesName, fuse]);
