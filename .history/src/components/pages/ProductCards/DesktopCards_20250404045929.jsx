                  ...
                  >
                    ...
                    <div style={{ display: "flex" }}>
                      ...
                      >
                        ...
                        {product.discount > 0 && (
                          <Discount key={index}>
                            {t("CFA")}{import React, { Component } from 'react'
                            
                            type Props = {}
                            
                            type State = {}
                            
                            class DesktopCards extends Component<Props, State> {
                              state = {}
                            
                              render() {
                                return (
                                  <div>DesktopCards</div>
                                )
                              }
                            }
                            
                            export default DesktopCards}:<s>{product.price}</s>
                            <label
                              style={{
                                width: "40px",
                                height: "20px",
