...
const Home = ({
  ...
  const groupBrandsByCategory = useCallback((categories, brands, products) => {
    return categories.reduce((acc, category) => {
      acc[category] = brands.filter((brand) =>
        products.some(
          (product) =>
            product.category === category &&
            product.brand.some((b) => b.name === brand)
        )
      );
      return acc;
    }, {});
  ...
  const groupedBrandsByCategory = useMemo(
    () => groupBrandsByCategory(categories, brands, glofilteredProducts),
    [categories, brands, glofilteredProducts, groupBrandsByCategory]
  );
