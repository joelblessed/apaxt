...
const CategoryPage = ({ filteredProducts, mobilefilteredProducts,api, searchTerm, highlightText,SelectedProduct, addToWishList, addToCart}) => {


  const [currentIndex, setCurrentIndex] = useState(0);
  const { filteredCategory } = useParams(filteredCategory);
    const [products, setProducts] = useState(filteredCategory);
