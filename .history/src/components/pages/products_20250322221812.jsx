     ...
     <React.Fragment>
      {filteredProducts.length >0 ?(
        filteredProducts.map((product,index) =>(
          <div key={index} style={{ display:"flex" ,margin:"20px",flexWrap:"wrap" ,width:"103px" ,background:"green", height:"250px", border:"1px solid red"}}>
          <div>
            <img
          ...
          <label>{t("Price")}:{product.description}</label>
          <label>{t("Description")}:{product.price}</label>
          </div>
          <div style={{justifyContent:"center", alignItems:"center", alignContent:"center", textAlign:'center'}}><button>{t("Add To Cart")}</button></div>
        </div>
        ))
      ):(
        <h6>loading</h6>
