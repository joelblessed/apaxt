                  ...
                  <div style={{ display: "flex" }}>
                    <div style={{ background: "", width: "40%" }}>
                      {selectedProd.images && selectedProd.images.length > 0 ? (
                        <Slider {...style.sliderSettings}>
                          {selectedProd.images.map((imgUrl, index) => (
                            <div key={index}>
                              <img
                                src={imgUrl}
                                alt={`${selectedProd.title} - Image ${index + 1}`}
                                style={{
                                  width: "100%",
                                  height: "500px",
                                  borderRadius: "8px",
                    ...
                    >
                      <div style={{ padding: "20px", margin: "0 auto" }}>
                        ...
                        <p>
                          <strong>Price:</strong> {selectedProd.price}
                        </p>
                      </div>
                      <div style={style.buttonsContainer}>
                        <div>
                          <button
                            style={style.buttons}
                            onClick={() => dispatch(addToCartBeforeLogin(selectedProd))}
                          >
                            Add To Cart
                          </button>
                        </div>
