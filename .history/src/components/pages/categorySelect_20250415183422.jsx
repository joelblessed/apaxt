...
const Category = ({
  ...
  const [category, setCategory] = useState(categoriesName || "All");
  ...
  useEffect(() => {
    if (categoriesName || searchTerm.trim() !== "") {
      const results = fuse.search(searchTerm.trim() || categoriesName.trim());
  ...
  }, [searchTerm, categoriesName, fuse]);
