...
const SelectedProduct = ({ api, selectedProduct,filteredProducts, addToCart,addToWishList,likedProducts,searchTerm,cart,inwishlist,selectedCategory,highlightText,toggleLike, setSelectedProduct }) => {
  const [product, setProduct] = useState(
    localStorage.getItem("selectedProduct") || SelectedProduct
  );
