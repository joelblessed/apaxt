  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Save the product in the user's array
        const userResponse = await fetch(${api}/users/${userId}/products, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
          body: JSON.stringify({ productId: responseData.productId }),
        });
  
        if (userResponse.ok) {
          alert("Product uploaded and saved to user successfully!");
          // Reset form
          setName("");
          ...
          alert("Failed to save product to user.");
        }
      } else {
