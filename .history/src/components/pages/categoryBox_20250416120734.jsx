...
const CategoryBox = ({
  ...
  const styles = {
    container: {
      display: "flex",
      flexDirection: "column", // Adjusted for mobile view
    ...
    Categorycontainer: {
      ...
      margin: "auto",
      marginTop: "50px", // Adjusted for mobile
      paddingRight: "10px", // Reduced padding
    },
    categoryContainer: { marginBottom: "10px" }, // Reduced margin
    categoryTitle: { color: "teal", fontSize: "18px" }, // Adjusted font size
    productsGrid: {
      display: "flex",
