...
const WishlistPage = ({filteredProducts}) => {
    ...
    const wishlist  = const idArray = useSelector((state) => state.wishlist.items)
    ...
    useEffect(() => {
        ...
        const filtered = filteredProducts.filter((product) => productId.includes(product.id.toString()));
