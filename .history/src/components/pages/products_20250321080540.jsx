      ...
      <div className="animated-box" style={styles.container}>
        {filteredProducts.length > 0 ? (
          filteredProducts.map((product, index) => (
            ...
            > <div  onMouseEnter={handleMouseEnter} style={{ padding: "20px", border: "1px solid black", width:"40px", background:'black'}}key={product.id}>
            <button  ref={buttonRef} onClick={() => setSelectedProduct(product)}>
