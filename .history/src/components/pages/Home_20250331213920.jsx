...
const Home = ({ brands, categories,discounts }) => {
  ...
  return (<>
  <div style={{justifyContent:'center', display:"flex",alignItems:"center", alignContent:"center", background:'green', marginRight:'auto'}}>
    <div style={{border:"2px solid black", width:"70%", height:"400px", boxShadow:"10px 10px 10px red",}}>
      discounts
    </div>
  </div>
    <Container>
