                ...
                {selectedProduct === product &&(
                   ...
                   >
                     <div style={{ display: "flex" }}>
                       ...
                       <div
                         style={{ background: "#4ECDC4", width: "500px", marginLeft: "30px" }}
                       >
                         <div style={{ padding: "20px", margin: "0 auto" }}>
                          <button style={{position }} onClick={()=> hanldleProductHid()}>close</button>
                ...
                <div style={{ display: "flex" }} >
                  ...
                  <div style={{ background: "" }}>
                    <div>
                      ...
                      {selectedProduct === product  &&(
                        <div >
                          <button onClick={() => toggleLike(selectedProduct)} styles={{border:"0px", background:"red"}}>
