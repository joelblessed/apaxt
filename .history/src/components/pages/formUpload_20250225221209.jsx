    ...
    <div style={{display:"row", marginTop:"90px", width:"60%"}}>
      ...
      <form onSubmit={handleSubmit}>
       ...
       <div  style={{display:"grid"}}>
        ...
        {errors.numberInStock && <p style={{color:"red"}}>{errors.numberInStock}</p>}
...
nput type="text" placeholder="Owner Name" value={owner} onChange={(e) => setOwner(e.target.value)} required />
