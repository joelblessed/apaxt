...
const Products = ({
  ...
  const [selectedProd,setSelectedProd] = useState(selectedProduct)
                ...
                >
                  <div style={{ display: "flex" }}>
                    <div style={{ background: "", width: "40%" }}>
                      {electedProd.images && electedProd.images.length > 0 ? (
                        <Slider {...style.sliderSettings}>
                          {electedProd.images.map((imgUrl, index) => (
                            <div key={index}>
                              <img
                                src={imgUrl}
                                alt={`${electedProd.title} - Image ${index + 1}`}
                                style={{
                                  width: "100%",
                                  height: "500px",
                                  borderRadius: "8px",
                    ...
                    >
                      <div style={{ padding: "20px", margin: "0 auto" }}>
                        <h1>{electedProd.name}</h1>
                        <p>{electedProd.description}</p>
                        <p>
                          <strong>Price:</strong> {electedProd.price}
                        </p>
                      </div>
                      <div style={style.buttonsContainer}>
                        <div>
                          <button
                            style={style.buttons}
                            onClick={() => dispatch(addToCartBeforeLogin(electedProd))}
                          >
                            Add To Cart
                          </button>
                        </div>
