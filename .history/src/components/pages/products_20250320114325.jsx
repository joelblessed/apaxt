...
const DescriptionTitle = styled.a`
  font-size:16px;
  color:black;
              ...
              <div style={{ display: "flex" }}>
                ...
                >
                  ...
                  <DescriptionContainer>
                   <DescriptionTitle>{t("Description")}</DescriptionTitle> : <DescriptionContent>{product.description}</DescriptionContent>
                  </DescriptionContainer>
                  <StatusContainer>
                     <StatusTitle>{t("Status")}:<StatusContent>{product.stat}</StatusContent></StatusTitle>
                  </StatusContainer>
