...
const Home = ({brands, categories}) => {
  ...
  const CatnextBoxes = () => {
    if (catstartIndex + boxesPerPage < boxes.length) {
      setCatStartIndex(startIndex + boxesPerPage);
    }
  };
  ...
  return (<>
    ...
    <div style={{ textAlign: "center",background:"", marginTop: "20px", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px" }}>
      ...
      {/* Hide "Previous" button when at the start */}
      {startIndex > 0 && (
        <button onClick={CarprevBoxes} style={{ padding: "10px", cursor: "pointer", background:"orange", border:"none" }}>less</button>
      )}
