...
const SelectedProductDesktop = ({ selectedProduct, handleProductHid }) => {
...
const text = "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quae, maiores necessitatibus deserunt ducimus nisi omnis. Culpa debitis perferendis accusantium itaque, aperiam inventore facere reprehenderit, quos veritatis perspiciatis error. Ad, excepturi perferendis. Corporis culpa quis doloribus consequatur obcaecati eveniet nisi voluptatem temporibus quibusdam deleniti officiis, voluptatum inventore incidunt a et, labore quisquam maiores ullam suscipit earum sapiente? Quae tempora vel porro sapiente ipsa culpa iure cupiditate, temporibus doloremque repellendus, saepe quaerat officia explicabo aliquid, sunt illo itaque dicta earum hic. Magnam, recusandae quidem aliquam nobis possimus provident tenetur assumenda enim, aperiam sapiente maxime voluptate aspernatur nesciunt incidunt, tempore facilis voluptates placeat?"  
const maxLength= 10
    ...
    <ModalOverlay>
      <ProductContainer>
        ...
        <TabContent>
          ...
          {activeTab === "description" && <p>{selectedProduct.description}{displayText}</p>}
        </TabContent>
      </ProductContainer>
    </ModalOverlay>
  );
