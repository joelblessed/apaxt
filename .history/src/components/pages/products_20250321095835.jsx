...
const Products = ({
  ...
  const handleProductClick = (product) => {
    setDisplaySelectedProduct(product);
                  ...
                  >
                    <div style={{ display: "flex" }}>
                      <div style={{ background: "", width: "40%" }}>
                        {sele.images && sele.images.length > 0 ? (
                          <Slider {...style.sliderSettings}>
                            {sele.images.map((imgUrl, index) => (
                              <div key={index}>
                                <img
                                  src={imgUrl}
                                  alt={`${sele.title} - Image ${index + 1}`}
                                  style={{
                                    width: "100%",
                                    height: "500px",
                                    borderRadius: "8px",
                      ...
                      >
                        <div style={{ padding: "20px", margin: "0 auto" }}>
                          <h1>{sele.name}</h1>
                          <p>{sele.description}</p>
                          <p>
                            <strong>Price:</strong> {sele.price}
                          </p>
                        </div>
                        <div style={style.buttonsContainer}>
                          <div>
                            <button
                              style={style.buttons}
                              onClick={() => dispatch(addToCartBeforeLogin(sele))}
                            >
                              Add To Cart
                            </button>
                          </div>
