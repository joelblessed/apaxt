...
import {Container,Section,ScrollContainer,ScrollWrapper,NavButton,Box} from "./home-styledComponents";
  ...
  return (
    <Container>
      ...
      <Section>
        ...
        {startIndex + boxesPerPage < brands.length && <NavButton onClick={nextBoxes}>▶</NavButton>}
      </Section>
      ...
      <Section>
        ...
        {catstartIndex + catboxesPerPage < categories.length && <NavButton onClick={CatnextBoxes}>▶</NavButton>}
      </Section>
    </Container>
  );
};
