                    ...
                    <div style={{ display: "flex" }}>
                      ...
                      >
                        <div style={{ padding: "20px", margin: "0 auto" }}>
                          <button
                            style={{ position:"relative", left:"450px", top:"-40px", background:"blue", borderRadius:"100px",  width:""border:"none",cursor:"pointer", fontWeight:"bold",fontSize:"30px", color:"red"}}
