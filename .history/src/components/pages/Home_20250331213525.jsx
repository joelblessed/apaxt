...
const Home = ({ brands, categories,discounts }) => {
  ...
  return (<>
  <div style={{justifyContent:'center', alignItems:"center", alignContent:"center", background:'green'}}>
    <div style={{border:"2p solid black", width:"70%", height:"400px", boxShadow:"10px 10px 10px red",justifyContent:'center', alignItems:"center", alignContent:"center"}}>
      discounts
    </div>
  </div>
    <Container>
