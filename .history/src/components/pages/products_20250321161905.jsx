               ...
               >
                 <div style={{ display: "flex" }}>
                   <div style={{ background: "", width: "40%" }}>
                     {selectedP.images && selectedP.images.length > 0 ? (
                       <Slider {...style.sliderSettings}>
                         {selectedP.images.map((imgUrl, index) => (
                           <div key={index}>
                             <img
                               src={imgUrl}
                               alt={`${selectedP.title} - Image ${index + 1}`}
                               style={{
                                 width: "200px",
                                 height: "200px",
                                 borderRadius: "8px",
                   ...
                   >
                     <div style={{ padding: "20px", margin: "0 auto" }}>
                       ...
                       <p>
                         <strong>Price:</strong> {selectedP.price}
                       </p>
                     </div>
                     <div style={style.buttonsContainer}>
                       <div>
                         <button
                           style={style.buttons}
                           onClick={() => dispatch(addToCartBeforeLogin(selectedP))}
                         >
                           Add To Cart
                         </button>
                       </div>
