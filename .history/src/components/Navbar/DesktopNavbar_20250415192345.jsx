  ...
  return (
    <Navbar>
      ...
      <NavList gap="20px">
        ...
        <NavItem>
          <NavLinkStyled to="/products" onClick={clearSearch}>
            {t("Products")}
          </NavLinkStyled>
        </NavItem>
        <NavItem>
          <NavLinkStyled to="/formUpload" onClick={clearSearch}>
            {" "}
            {t("Sell")}
          </NavLinkStyled>
        </NavItem>
        <NavItem>
          <NavLinkStyled to={`/categorySelect`} onClick={clearSearch}>
            <StyledSelect
              value={categoryName}
              onChange={(e) => {
                const selectedCategory = e.target.value;
                setCategoryName(selectedCategory);
                navigate(`/categorySelect/${selectedCategory}`);
              }}
            >
              <StyledOption value="All Categories">All Categories</StyledOption>
