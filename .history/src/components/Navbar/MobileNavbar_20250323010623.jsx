    ...
    <>
      ...
      <ul  style={{ listStyleType: "none", padding: 0 }}><h4> brands:</h4> 
        {brands.map((bra, index) => (
          <li
            key={index}
            onClick={() => {setBrand(brand); goToCategory(); setIsMenuOpen(false)}}
            style={{
              cursor: "pointer",
              fontWeight: brand === brand ? "bold" : "normal",
              color: brand === brand? "blue" : "black",
          ...
          >
             <h4 style={{ color: "red", margin: 0 }}>{brand}</h4>
          </li>
        ))}
      </ul>
