...
import { useTranslation } from "react-i18next";import { useNavigate, useParams, Link } from "react-router-dom";
  ...
  return (
    <Navbar>
      ...
      <NavList gap="20px">
        ...
        <NavItem>
          <NavLinkStyled  to="/formUpload" onClick={goTo()} >{t("Sell")}</NavLinkStyled>
        </NavItem>
        <NavItem>
