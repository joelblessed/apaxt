  ...
  return (
    <>
      ...
      <MobileMenu isOpen={isMenuOpen}>
        <li>
          <MobileNavLink  onClick={() => {setIsMenuOpen(false)}} to="/">
            Home
          </MobileNavLink>
        </li>
        <li>
          <MobileNavLink onClick={() => {setIsMenuOpen(false)}}  to="/products">
            Products
          </MobileNavLink>
        </li>
        <li>
          <MobileNavLink  onClick={() => {setIsMenuOpen(false)}}  to="/newProduct">
            Sell
          </MobileNavLink>
        </li>
        <li  style={{ listStyleType: "none", padding: 0 }}>
          <MobileNavLink onClick={()=>{setIsOpen(true)}}> categories</MobileNavLink>
      ...
      <ul  style={{ listStyleType: "none", padding: 0 }}><h4> brands:</h4> 
        {brands.map((bra, index) => (
          <li
            key={index}
            onClick={() => {setBrand(bra); goToCategory(); setIsMenuOpen(false)}}
            style={{
              cursor: "pointer",
