            ...
            <div>
              <div style={{ display: "flex" }}>
                <div>
                  ...
                  {isOpen && (
                   ...
                   <div>   {isOpen === true && (
                    <button  style={{borderRadius:"5px", border:"1px solid orange", background:"none", color:""}}  onClick={() => brandShow(cat)}>Brands  <img src="/images/expand_all_24dp_FC0202_FILL0_wght400_GRAD0_opsz24.svg" /></button>
                  )}{" "}</div>
                   </div>
                    </li>
                  )}
              ...
              {isBrandOpen &&
                ...
                [
                  ...
                  style={{
                    cursor: "pointer",
                    fontWeight: brandName === brand.name ? "bold" : "normal",
