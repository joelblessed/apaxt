      ...
      <MobileMenu isOpen={isMenuOpen}>
        ...
        <li style={{ listStyleType: "none", padding: 0 }}>
          ...
          >
            <MobileNavLink>
              {t("Categories")}
              {!iCaOpen ?                                 <svg width="20px" height="20px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
...
</svg> : <svg width="20px" height="20px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
  <path d="M0 0h48v48H0z" fill="none"/>
  <g id="Shopicon">
                        ...
                        <div style={{ display: "flex", gap: "5px" }}>
                          ...
                          <div>
                            ...
                            {isOpen === true && (
                              ...
                              >
                                Brands{" "}
                                {!isBrandOpen ?                                 <svg width="20px" height="20px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
  <path d="M0 0h48v48H0z" fill="none"/>
  <g id="Shopicon">
    <g>
      <polygon points="24,29.171 9.414,14.585 6.586,17.413 24,34.827 41.414,17.413 38.586,14.585 		"/>
