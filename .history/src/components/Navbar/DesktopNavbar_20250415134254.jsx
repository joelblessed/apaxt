 ...
 setSearchTerm("")
  ...
  return (
    <Navbar>
      ...
      <NavList gap="20px">
        <NavItem>
          <NavLinkStyled  to="/" onClick={clearSearch} exact>
          {t("Home")}
          </NavLinkStyled>
        </NavItem>
        <NavItem>

          <NavLinkStyled  to="/products" onClick={clearSearch}>{t("Products")}</NavLinkStyled>
        </NavItem>
        <NavItem>
          <NavLinkStyled  to="/formUpload" onClick={clearSearch}>  {t("Sell")}</NavLinkStyled>
        </NavItem>
        <NavItem>
          <NavLinkStyled  to="/category" onClick={clearSearch}> 
            ...
            >
              ...
              {categories.map((category, index) => (
                <StyledOption onClick={() =>{setSearchTerm(category);setCategory(category); setCategoryName(category)}} key={index} value={category}>
                  <h4 style={{color:"red"}}>
        ...
        <NavItem>
          <NavLinkStyled to="/cart" onClick={clearSearch}>
            <CartContainer>
        ...
        <NavItem>
          <NavLinkStyled to="/dashboard" onClick={clearSearch}>
            <AccountContainer>
          {imageError ?(
              <svg
              xmlns="http://www.w3.org/2000/svg"
