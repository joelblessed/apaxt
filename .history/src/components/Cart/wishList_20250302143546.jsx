...
import { addToWishListBeforeLogin, loadWishListAfterLogin, removeFromWishAPI, clearCartOnLogout } from "../../wishlistActionAction";
...
const Cart = () => {
    ...
    const handleRemoveFromCart = (productId) => {
        dispatch(removeFromWishAPI(productId));
    };
