...
import { addToWishListBeforeLogin, loadWishAfterLogin, removeFromCartAPI, clearCartOnLogout } from "../../wishlistActionAction";
...
const Cart = () => {
    ...
    useEffect(() => {
        if (token) {
            dispatch(loadWishAfterLogin()); // Merge local and server cart
        }
    }, [dispatch, token]);
