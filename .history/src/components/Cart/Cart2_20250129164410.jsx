...
fetch(`http://localhost:5000/cart/${itemId}/increment`, requestOptions)
...
fetch(`http://localhost:5000/cart/${itemId}/decrement`, requestOptions)
  .then(response => response.text())
  .then(result => console.log(result))
  .catch(error => console.log('error', error));
  setProducts(
  ...
  const deleteItem = async (itemId) => {
    try {
      await  fetch(`http://localhost:5000/cart/${it}`, requestOptions)
      .then(response => response.text())
      .then(result => console.log(result))
      .catch(error => console.log('error', error));
                        ...
                        <div style={{ display: "grid", width: "100%" }}>
                          ...
                          >
                            ...
                            >
                              ...
                              <button className="btn btndisable"
                                style={{
                                  border: "1px solid grey",
                                  width: "50px",
                                  borderRadius: "8px",
