                      ...
                      <div style={{display:"grid",width:"100%" }}>
                        ...
                        <span className='text' style={{background:"green", height:"72px",width:"200px", marginTop:"-16px"}}>
                               ...
                               <div style={{background:"",display:"flex", justifyContent:"space-between"}}>
                                <label style={{border :"1px solid blue", width:"40px",borderRadius:"8px",color:"white",fontWeight:"bold", background:"blue", height:"25px",textAlign:"center",fontSize:"15px"}}></label>
